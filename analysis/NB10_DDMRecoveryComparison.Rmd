...
So first check if a model with distortion but no early integration converges on the correct parameter combination. -- running in python, need to test translation in R
...
Then check if either behavior differently in python? (epsilon might make a difference)
