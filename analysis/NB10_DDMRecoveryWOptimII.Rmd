...
par_recovery_report(model_ = model_name, data_ = data_name, optim_out_path_=optim_out_path, true_pars_path=true_pars_path, param_dict_=param_dict)
```

```{r}
par_recovery_report(model_ = model_name, data_ = data_name, optim_out_path_=optim_out_path, diff_pct_plots_ = FALSE, start_end_scatter_ = TRUE, true_pars_path=true_pars_path, param_dict_=param_dict)
```

```{r}
par_recovery_report(model_ = model_name, data_ = data_name, optim_out_path_=optim_out_path, diff_pct_plots_ = FALSE, par_hist_= TRUE, true_pars_path=true_pars_path, param_dict_=param_dict)
```
