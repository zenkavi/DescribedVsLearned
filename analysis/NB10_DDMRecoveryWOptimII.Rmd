...
```{r}
ddm_par_recovery_report(model_ = model_name, data_ = data_name, optim_out_path_=optim_out_path, diff_pct_plots_ = FALSE, start_end_scatter_ = TRUE)
```

```{r}
ddm_par_recovery_report(model_ = model_name, data_ = data_name, optim_out_path_=optim_out_path, diff_pct_plots_ = FALSE, par_hist_= TRUE)
```
