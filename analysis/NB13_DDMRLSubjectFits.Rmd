...
for(i in 1:length(subnums)){
  cur_sub = subnums[i]
  cur_stim = all_trials_data %>% filter(subnum == as.numeric(cur_sub))
...
What behavioral effect to compare?
Psychometric curve
Logit curves
RT distributions for each pFractalDraw level
`sim_sanity_checks`?
...
true_data = read.csv('/Users/zeynepenkavi/Downloads/GTavares_2017_arbitration/behavioral_data/all_trials.csv')
