...
Are they faster when they choose left vs right? Since the learned attribute options are both fractals the stimulus difference lies in the lotteries. The bundle on the left has the fixed and the one on the right has the varying lottery. So right choices might be slower since they require more processing.
...
**How can you parse choice without using any model-based measures?**
...
When the lotteries don't have the same EV do subjects choose the bundle with the better lottery? No. This suggests terrible performance.
...
Why are both of them low? If you choose the bundle with the better lottery isn't choice of bundle with better fractal 0? Yes for conflict trials, no for no conflict.
