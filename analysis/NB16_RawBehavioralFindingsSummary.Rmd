...
Is the ratio of the slopes for EV at (1-p) and QV at p constant?  When fractal matters equally or more for the reward the ratio of EV slope to QV slope, i.e. ambiguity aversion relatively constant.

Note to add error bars to this plot you need to use the formula described [here](https://en.wikipedia.org/wiki/Taylor_expansions_for_the_moments_of_functions_of_random_variables).
...
clean_beh_data %>%
  ...
  geom_point()+
  geom_line(group=1)+
  labs(x = "p(Fractal)", y="Ambiguity Aversion\nslope(EVDiff)/slope(fractalDiff)")
