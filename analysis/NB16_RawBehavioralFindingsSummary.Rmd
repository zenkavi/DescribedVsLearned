...
One suggestion from lab meeting was to compare predicted probability versus true proportion of choice for ...

### Posterior predictive check from vanilla RL
...
We decided not to go through with this because there are several issues with this approach:  
