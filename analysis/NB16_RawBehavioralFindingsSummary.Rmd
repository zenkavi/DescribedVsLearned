...
**But the sequential nature of the model is crucial and this summary does not capture that.**
...
pp_data %>%
  ...
  geom_point()+
  geom_errorbar(aes(ymin=mean_propLeft-sem_propLeft, ymax=mean_propLeft+sem_propLeft), width=.01)+
