...
sub_par_ests_ddrl = sub_par_ests
...
Estimates overlapping for most subjects. So I'll stick to estimating this parameter from RL alone since DDRL is a more complicated model that fails the posterior predictive check for half the data it's modeling (RTs).
...
Model 1e:
Unbounded distortion - will examine this as part of RL only models in NB19_RevisitingRLModels.
