...
*add model with double symmetry (normalization) to comparison set*
*rank models using waic and/or loo-cv*
...
rm(i, j, k, l, model_name, tmp, numpar_names, rpe_names, shape_names, symm_names, prefix, cur_row)
