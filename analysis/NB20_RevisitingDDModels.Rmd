...
So then, despite the similarity in parameter estimates are the oneIntegrator without extreme case fits that used the distorted values from the asymmetric model worse fits/have lower likelihoods?
