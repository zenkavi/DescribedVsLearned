...
```{r}
threeIntDemo = sim_task(sub_stims, model_name = "model3", dLott=0.003, dFrac=0.006, dArb=0.007, sigmaLott = 0.03, sigmaFrac = 0.03)
```

```{r}
sim_sanity_checks(threeIntDemo, checks=c(1,3,4,5,6,7,8), compare_logits = T, compare_rts = T, true_data = sub_stims)
```
