...
```{r}
sim_sanity_checks(sub_data, checks=c(1,3,4,5,6,7,8), compare_logits = F, compare_rts = FALSE)
```
...
tmp = sim_trial(dLott=.25, dFrac=.25, dArb=.25, sigmaLott = 0.05, sigmaFrac = 0.05, distortedEVDiff = .25, distortedQVDiff = -.1, probFractalDraw = 2, barrierDecay = 0, bias = 0, EVLeft = NA, EVRight = NA, QVLeft = NA, QVRight = NA, debug=TRUE)
...
```{r}
# tmp_fit = fit_trial(dLott=1, dFrac=1, dArb=1, sigmaLott = 0.001, sigmaFrac = 0.001, distortedEVDiff = .25, distortedQVDiff = -.1, probFractalDraw = 2, barrierDecay = 0, bias = 0, EVLeft = NA, EVRight = NA, QVLeft = NA, QVRight = NA,
#                     choice = tmp$out$choice, reactionTime = tmp$out$reactionTime, debug=TRUE)

tmp_fit = fit_trial(dLott=.25, dFrac=.25, dArb=.25, sigmaLott = 0.05, sigmaFrac = 0.05, distortedEVDiff = .25, distortedEVDiff = .25, distortedQVDiff = -.1, probFractalDraw = 2, barrierDecay = 0, bias = 0, EVLeft = NA, EVRight = NA, QVLeft = NA, QVRight = NA,
                    choice = tmp$out$choice, reactionTime = tmp$out$reactionTime, debug=TRUE)
...
Simulated data using the MLE for each subject
