...
```{r}
source(paste0(helpers_path,'ddmSims/r_ddm_models/sim_task.R')) # do this first not to mess with cluster setup?
source(paste0(helpers_path,'ddmSims/r_ddm_models/sim_sanity_checks.R'))
source(paste0(helpers_path,'rlModels/fit_twoValSystemsWithRL_hierarchical.R'))
...
```{r}
source(paste0(helpers_path, 'ddmSims/r_ddm_models/ddm_model2.R'))
...
```{r}
source(paste0(helpers_path, 'ddmSims/r_ddm_models/ddm_model2a.R'))
...
```{r}
source(paste0(helpers_path, 'ddmSims/r_ddm_models/ddm_model4a.R'))
...
```{r}
source(paste0(helpers_path, 'ddmSims/r_ddm_models/ddm_model4b.R'))
...
```{r}
source(paste0(helpers_path, 'ddmSims/r_ddm_models/ddm_model5a.R'))
...
```{r}
source(paste0(helpers_path, 'ddmSims/r_ddm_models/ddm_model5b.R'))
...
```{r}
source(paste0(helpers_path, 'ddmSims/r_ddm_models/ddm_model6a.R'))
...
```{r}
source(paste0(helpers_path, 'ddmSims/r_ddm_models/ddm_model6b.R'))
...
```{r}
source(paste0(helpers_path, 'ddmSims/r_ddm_models/ddm_model6c.R'))
