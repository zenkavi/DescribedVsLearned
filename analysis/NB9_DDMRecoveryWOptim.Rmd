...
For each of the 1000 iterations where did each parameter start and end?
...
# Read in all the converged values

# Match them with their starting values
# Prob best to use the iter df
```
...
Which converged point has the highest likelihood?
