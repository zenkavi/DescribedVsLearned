...
# ./run_ddm_Roptim.sh -m model1c -d sim_single_sub_data46 -s test_data/ddm_Roptim_start_vals46.csv -p d,sigma,delta -o sim3
# ./run_ddm_Roptim.sh -m model1c -d sim_single_sub_data46 -s test_data/ddm_Roptim_start_vals46.csv -p d,sigma -o sim3b -r 2 -f delta -v 1
