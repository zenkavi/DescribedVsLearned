sim_trial = function(d, sigma, barrierDecay, delta, barrier=1, nonDecisionTime=0, bias=0, timeStep=10, maxIter=400, epsilon = 0, debug=FALSE,...){
...
fit_trial = function(d, sigma, barrierDecay, delta, barrier=1, nonDecisionTime=0, bias=0, timeStep=10, epsilon = 0, approxStateStep = 0.1, debug=FALSE, ...){
