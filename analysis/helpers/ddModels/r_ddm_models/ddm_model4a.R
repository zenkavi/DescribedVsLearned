sim_trial = function(dArb, dLott, dFrac, sigmaArb, sigmaLott, sigmaFrac, barrierDecay, barrier=1, nonDecisionTime=0, lotteryBias=0.1, timeStep=10, maxIter=400, epsilon = 0.002, debug=FALSE,...){
  ...
  fractal_mu_mean = dFrac * probFractalDraw * (QVLeft - QVRight)
