sim_trial = function(d, sigma, barrierDecay, theta, barrier=1, nonDecisionTime=0, bias=0, timeStep=10, maxIter=400, epsilon = 0.0002, stimDelay = 2000, debug=FALSE,...){
  ...
  weighted_mu_mean = d * ((1-theta)*leftFractalAdv + (1+theta)*leftLotteryAdv)
