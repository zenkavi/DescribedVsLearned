...
# ./run_ddrl_Roptim.sh -m model1c -d test_data/sim_single_sub_data1 -s test.csv -p d,sigma,alpha,delta -o sim1
# ./run_ddrl_Roptim.sh -m model1c -d test_data/sim_single_sub_data1 -s ddrl_Roptim_start_vals1.csv -p d,sigma,alpha,delta -o sim1
# ./run_ddrl_Roptim.sh -m model1c -d test_data/sim_single_sub_data46 -s ddrl_Roptim_start_vals46.csv -p d,sigma,alpha -o sim3b -r 2 -f delta -v 1
