...
source(paste0(helpers_path,'rlModels/fit_rl_hierarchical_twoParamsSymmNonLinearProbDistortion_rpeWhenFractalRewarded.R'))
fit_rpeWhenFractalRewarded = fit
g_par_ests_rpeWhenFractalRewarded = g_par_ests
par_ests_rpeWhenFractalRewarded = par_ests

source(paste0(helpers_path,'rlModels/fit_rl_hierarchical_twoParamsSymmNonLinearProbDistortion_rpeChosenBundleFractal.R'))
