...
if(file.exists(paste0(helpers_path, 'rlModels/stanModels/fit_rl_hierarchical_twoParamsAsymmLinear_rpeBoth.RDS'))){
  fit = readRDS(paste0(helpers_path, 'rlModels/stanModels/fit_rl_hierarchical_twoParamsAsymmLinear_rpeBoth.RDS'))
  ...
  m = stan_model(paste0(helpers_path,'rlModels/stanModels/fit_rl_hierarchical_twoParamsAsymmLinear_rpeBoth.stan'))
  
  fit_linearW = sampling(m, data=m_data)
  saveRDS(fit_linearW, paste0(helpers_path, 'rlModels/stanModels/fit_rl_hierarchical_twoParamsAsymmLinear_rpeBoth.RDS'))
}
