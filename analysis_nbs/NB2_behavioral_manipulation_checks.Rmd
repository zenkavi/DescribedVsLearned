...
When the fractal and lottery are equally likely AND the better lottery and better fractal suggest different options do subjects chose more frequently based on the lottery or their fractal Q Value? Yes.
...
clean_beh_data %>%
  ...
  summarise(choseBetterLottery = sum(choseBetterLottery),
            choseBetterFractal = sum(choseBetterFractal))
