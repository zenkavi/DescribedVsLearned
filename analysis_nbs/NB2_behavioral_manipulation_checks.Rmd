...
When the better lottery and the better fractal (based on the learned Q value) suggest different options do subjects chose more frequently based on the lottery or their fractal Q Value? Yes.
...
clean_beh_data %>%
  ...
  geom_boxplot()+
  # geom_point(alpha=.3,position = position_dodge(width=.75))+
  labs(x="p(Fractal)",
       y="p(choice)",
       color="")
