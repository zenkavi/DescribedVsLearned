...
For each parameter combination the simulations below are for 25 subjects completing 5 runs of 60 trials with the same drift parameters for the fractal reward probabilities.
...
tmp %>%
  ...
  labs(title = "Mean log likelihood from 25 simulations per cell", 
       ...
       fill="")
```
Since each cell in the plot below is the average of 25 subjects there is variability in the likelihoods. The plot below depicts this variability as a combination of  
