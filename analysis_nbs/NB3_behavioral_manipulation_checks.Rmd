...
The dependence of choice on the bundle value difference holds for all levels of p(Frac).
...
clean_beh_data_noProbDistortion = beh_data %>%
  filter(responded == 1,
         reactionTime > .2)
rm(beh_data)
clean_beh_data_noProbDistortion = add_inferred_pars(clean_beh_data_noProbDistortion, par_ests_noProbDistortion)
