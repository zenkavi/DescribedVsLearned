...
Why don't people choose using the relevant attribute all the time? Why do they overuse description-based attributes even when experience-based ones are more relevant for reward?

- Do they not learn the fractal values well?
  - The fractal Q-values in this notebook are based on modeling choice behavior
  - First order of business: Model both attributes together and see if these effects hold with RL parameter estimates from the join model.
