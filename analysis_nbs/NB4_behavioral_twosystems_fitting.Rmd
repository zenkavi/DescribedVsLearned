...
How does the distortion change for different values of delta and probDistortion? This isn't based on data. It is to build intuition to understand what each prob fractal might look like for different estimates for subjects.
