...
How does the distortion change for different values of delta and probDistortion? This isn't based on data. Just to build intuition to understand what each prob fractal might look like for different estimates for subjects.

$$w(\pFrac) = \frac{\delta\pFrac^\gamma}{\delta\pFrac^\gamma+(1-\pFrac)^\gamma}$$
delta = 0, w(pFrac) = 0
pFrac = 0, w(pFrac) = 0 iff gamma !=  0
gamma = 0, w(pFrac) = delta/(delta+1) 
