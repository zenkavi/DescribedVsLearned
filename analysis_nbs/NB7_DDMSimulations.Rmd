...
```{r}
sim_trial = function(d, sigma,  barrier=1, barrierDecay=.1, nonDecisionTime=0, bias=0, timeStep=10, maxIter=1000, epsilon = 0.0002,...){
...
```{r}
sim_sub_data_m2_1 = sim_task(sub_data = sub_data, d = .01, sigma = .1)
```

```{r}
sim_sanity_checks(sim_sub_data_m2_1)
```

```{r}
sim_sub_data_m2_2 = sim_task(sub_data = sub_data, d = .005, sigma = .05)
```

```{r}
sim_sanity_checks(sim_sub_data_m2_2)
```
