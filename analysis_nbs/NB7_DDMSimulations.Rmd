...
simulate_trial = function(d, sigma, valueLeft, valueRight, barrier=1, nonDecisionTime=0, bias=0, timeStep=10, maxIter=1000){
...
```{r}
simulate_trial(d=.02, sigma = .1, valueLeft=1, valueRight=1)
```
