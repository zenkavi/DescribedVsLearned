...
- Single parameter `theta` controls how much lotteries should be overweighted and how much fractals should be underweighted. It was an initial effort to induce different drift rates for the attributes.
