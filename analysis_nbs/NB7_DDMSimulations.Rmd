...
```{r eval=FALSE, echo=FALSE}
tmp = sim_task(sub_data, model_name = "model6", dAttr=0.02, dArb=0.06, sigmaAttr = 0.03, sigmaArb = 0.03, debug = TRUE, lotteryBias = .25)
sim_sanity_checks(tmp)
```

```{r eval=FALSE, echo=FALSE}
tmp = sim_task(sub_data, model_name = "model6", dAttr=0.02, dArb=0.06, sigmaAttr = 0.03, sigmaArb = 0.03, lotteryBias = .01)
sim_sanity_checks(tmp)
```
