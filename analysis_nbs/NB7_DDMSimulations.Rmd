...
```{r}
model_summary = data.frame(model_name = "Model1",
                           description = "Simplest",
                           RT_inverseU = "No, similar for all levels",
                           RT_fasterpFrac1 = "No",
                           choice_logits = "Reasonable",
                           choice_lotteryBias = "No")
model_summary
```
...
```{r}
model_summary = rbind(model_summary, data.frame(model_name = "Model2",
                                                description = "Early integration+rel pref weighting",
                                                RT_inverseU = "Yes but ends too fast and bimodal distributions",
                                                RT_fasterpFrac1 = "Yes but too fast",
                                                choice_logits = "Too high for edge case",
                                                choice_lotteryBias = "Slight to none."))
model_summary
```
...
```{r}
model_summary = rbind(model_summary, data.frame(model_name = "Model3",
                                                description = "Early integration+rel pref weighting",
                                                RT_inverseU = "No, either ends too fast or all too slow",
                                                RT_fasterpFrac1 = "Yes but not fast enough",
                                                choice_logits = "Too high for edge case",
                                                choice_lotteryBias = "Slight to none."))
model_summary
```
...
```{r}
model_summary = rbind(model_summary, data.frame(model_name = "Model4",
                                                description = "3 integrators with relevance on attribute integrators",
                                                RT_inverseU = "No",
                                                RT_fasterpFrac1 = "No, too fast",
                                                choice_logits = "Can be reasonable or too noisy",
                                                choice_lotteryBias = "Slight to none."))
model_summary
```
...
```{r}
model_summary = rbind(model_summary, data.frame(model_name = "Model5",
                                                description = "3 integrators with relevance on arbitrator",
                                                RT_inverseU = "No",
                                                RT_fasterpFrac1 = "No",
                                                choice_logits = "Too noisy or too slow",
                                                choice_lotteryBias = "No."))
model_summary
```
