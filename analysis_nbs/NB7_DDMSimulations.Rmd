...
```{r eval=FALSE, echo=FALSE}
tmp = sim_task(sub_data, model_name = "model2", d=0.06, sigma = 0.03)
sim_sanity_checks(tmp)
```
...
```{r}
tmp1 = sim_task(sub_data, model_name = "model2", d=0.06, sigma = 0.03)
sim_sanity_checks(tmp1, checks=c(3))
```

```{r}
tmp2 = sim_task(sub_data, model_name = "model2", d=0.06, sigma = 0.003)
sim_sanity_checks(tmp2, checks=c(3))
```

```{r}
tmp3 = sim_task(sub_data, model_name = "model2", d=0.006, sigma = 0.03)
sim_sanity_checks(tmp3, checks=c(3))
```

```{r}
tmp4 = sim_task(sub_data, model_name = "model2", d=0.006, sigma = 0.003)
...
```{r eval=FALSE, echo=FALSE}
tmp = sim_task(sub_data, model_name = "model3", d=0.05, sigma = 0.02)
sim_sanity_checks(tmp)
```
