...
```{r}
sim_trial(d = .008, sigma = .01, barrierDecay = 0.03, EVLeft = 0.7, EVRight = .1, QVLeft = 0.7, QVRight = 0.1, probFractalDraw = 1, debug=TRUE)
...
```{r}
sim_data_m2_1 = sim_task(stimuli=sub_data, d = .03, sigma = .03, barrierDecay = 0.1)
```
