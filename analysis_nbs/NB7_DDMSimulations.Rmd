...
Too fast with d=0.01. Can we slow it down with d=.005. Yes (with)

```{r}
sim_sub_data1 = sim_task(sub_data = sub_data, d = .005, sigma = .1)
sim_sanity_checks(sim_sub_data1)
```
...
```{r}
sim_sub_data1 = sim_task(sub_data = sub_data, d = .005, sigma = .05)
sim_sanity_checks(sim_sub_data1)
```
