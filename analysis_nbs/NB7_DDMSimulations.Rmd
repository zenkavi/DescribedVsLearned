...
- Attribute relevant (pFractalDraw) affects attribute integrators directly, not the arbitrator
...
- Attribute relevance (pFractalDraw) does affect attribute integrators directly
...
```{r eval=FALSE, echo=FALSE}
tmp = sim_task(sub_data, model_name = "model7", dAttr=0.03, dArb=0.02, sigmaAttr = 0.03, sigmaArb = 0.01, lotteryBias = .15)
sim_sanity_checks(tmp)
```
