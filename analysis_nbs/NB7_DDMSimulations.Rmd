...
```{r}
tmp = sim_trial(d = .001, sigma = .01, barrierDecay = 0, EVLeft = 0.9, EVRight = 0.1, QVLeft = 0, QVRight = 0, probFractalDraw = 0, debug=TRUE, nonDecisionTime = 200)
...
```{r}
sim_data_m4_1 = sim_task(stimuli=sub_data, d = .002, sigma = .02, barrierDecay = 0)
```
