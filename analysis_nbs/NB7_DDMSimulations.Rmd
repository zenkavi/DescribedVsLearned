...
```{r}
sim_data_m1_1 = sim_task(stimuli = sub_data, model_name = "model1",d = .05, sigma = .025)
```
...
```{r}
find_best_par_combo(sub_data, model_name = "model1", d_par_space = c(.003, .01, .05, .1), sigma_par_space = c(.001, .01, .03), heatmaps=TRUE)
```
