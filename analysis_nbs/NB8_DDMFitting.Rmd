...
```{r}
optim(c(.01, .01, 1.5, 1.5, .004), get_task_nll, data=true_dat, par_names = c("d", "sigma", "delta", "gamma", "epsilon"), model_name="model2b", method="L-BFGS-B", lower = c(0,0,1,1,0), upper = c(.5, 1, 5, 5, .1))
```
